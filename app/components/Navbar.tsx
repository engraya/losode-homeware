  ...
  return (
    <header className="sticky top-0 z-50 shadow">
      ...
      {/* Main Navbar */}
        ...
        <div className="hidden md:flex justify-between bg-gray-950 items-center mx-auto py-4 px-6 sm:px-3 lg:px-16">
        {/* LEFT: Nav Links */}
        ...
        <div className="flex items-center space-x-4">
            ...
            <input
                type="text"
                placeholder="Search..."
                className="pl-9 pr-3 py-1.5 border border-gray-300 rounded-md text-sm text-white focus:outline-none focus:ring-2"
            />
            </div>
