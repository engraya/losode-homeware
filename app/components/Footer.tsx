...
function Footer() {
  return (
    <footer className="relative bottom-0 z-50 shadow bg-black text-white overflow-hidden">
  {/* Main footer content */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
      ...
      <div className="group">
        ...
        <div className="flex space-x-4">
          ...
          <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-purple-500 hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300">
